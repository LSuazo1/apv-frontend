          ...
          >
            <div className="my-3">
              ...
              <input type="password"
                ...
                name="pwd_actual"
                placeholder="Escribre tu password actual"
            ...
            <input
              ...
              className="bg-indigo-700 px-10 py-3 font-bold pointer text-white rounded-lg w-full uppercase mt-5"
            />
          </form>
        </div>
      </div>
